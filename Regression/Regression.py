...
# # Linear regression and logistic regression classes
# # are defined in this module.
# 
# # Since an iterative solution technique is used here
# # for both types of regression, the code can be
# # refactored by inheriting from a base class.
# 
# # (The linear regression problem can also be solved using 
# # the direct method - see other code produced elsewhere).
